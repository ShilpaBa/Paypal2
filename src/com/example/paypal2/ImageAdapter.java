...
/**
 * This adapter class handles all the images which can be downloaded the website.
 * 
...
//        "http://lh5.ggpht.com/_MoEPoevCLZc/S9fHzNgdKDI/AAAAAAAADwE/UAno6j5StAs/s144-c/c84_7083.jpg",
    ...
    public int getCount() {
    	Log.d("getCount", URLS.length+"");
        return URLS.length;
    }

    public String getItem(int position) {
    	Log.d("getItem", URLS[position]+"");
        return URLS[position];
    }

    public long getItemId(int position) {
    	Log.d("getItemId", URLS[position].hashCode()+"");
